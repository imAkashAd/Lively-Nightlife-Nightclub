...
class UserFollowingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String titleText = isOther ? '${otherUser!.name}\'s Following' : 'Following';
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: Obx(() {
                    final list = isOther
                        ? controller.allUsers.where((u) => u.username != otherUser!.username && u.isFollowing.value).toList()
