...
class UserProfileSettingController extends GetxController {
  // Profile Info
  ...
  final String profileImageUrl = 'https://i.pravatar.cc/150?img=10';
  ...
  // Switch to Club flow
  void switchRoleToClub() {
    Get.offAllNamed(AppRoute.clubBottomNavbarView);
  }
